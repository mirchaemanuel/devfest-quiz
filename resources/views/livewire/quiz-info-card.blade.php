<div class="group m-2 p-2 w-[350px] md:w-[400px] h-[250px] rounded border border-gray-400 hover:bg-gray-100 dark:hover:bg-gray-900 shadow-lg text-gray-900 dark:text-white">
    <div class="h-full flex flex-col gap-2 justify-between items-stretch">
        <h4 class="font-bold text-xl text-center">{{ $quiz->title }}</h4>
        ...
        <div class="flex flex-col justify-end items-stretch">
            ...
            <div class="w-full text-right">
                <a class="font-extrabold text-2xl hover:underline text-right cursor-pointer text-blue-600 dark:text-blue-200"
