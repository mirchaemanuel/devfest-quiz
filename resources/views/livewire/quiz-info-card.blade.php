   ...
   href="{{ route('pages.members.quiz.show', $quiz) }}" wire:navigate>
    <div class="flex h-full flex-col items-stretch justify-between gap-2">
        ...
        <div class="flex items-center justify-center">
            <img src="{{ Vite::asset('resources/assets/images/quizfest.png') }}" class="h-8 w-8" alt="image logo" title="LOGO" />
        </div>
        <div class="flex flex-col items-stretch justify-end">
            ...
            <div class="w-full text-right">
                <div class="cursor-pointer text-right text-2xl font-extrabold text-blue-600 group-hover:underline dark:text-blue-200">
                    {{ __('Play quiz') }}
                </div>
            </div>
        </div>
