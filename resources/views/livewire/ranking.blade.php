<div class="">
    ...
    <div class="-mx-4 mt-2 mb-2 ring-1 ring-gray-300 sm:mx-0 sm:rounded-lg bg-gray-100">
        <table class="min-w-full divide-y divide-gray-300 bg-gradient-to-b from-gray-100 via-white to-white">
            <thead>
            <tr class="bg-gray-200">
                <th scope="col"
                    class="py-3.5 pl-4 pr-3 text-left text-base font-semibold text-gray-900 sm:pl-6">{{ __('User') }}</th>
                <th scope="col"
                    class="py-3.5 pl-4 pr-3 text-left text-base font-semibold text-gray-900 sm:pl-6 ">{{ __('Score') }}</th>
            </tr>
            </thead>
